...
// import { DAI_ADDRESSES, GDAO_ADDRESSES } from "src/constants/addresses";
...
//   const { data: ohmBalance = new DecimalBigNumber("0", 9) } = useBalance(GDAO_ADDRESSES)[networks.MAINNET];

//   const { data: currentPrice = 0 } = useGdaoPrice();
