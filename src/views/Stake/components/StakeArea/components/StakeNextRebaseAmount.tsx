...
export const StakeNextRebaseAmount = () => {
  ...
  const sgdaoTokens = [sgdaoBalances[networks.TESTNET_GOERLI].data];
  ...
  // ];
  const xgdaoTokens = [xgdaoBalances[networks.LOCALHOST].data, xgdaoBalances[networks.TESTNET_GOERLI].data];
  ...
  if (rebaseRate && sgdaoTokens && totalXgdaoBalance && currentIndex) {
