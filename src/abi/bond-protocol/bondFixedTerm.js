const bondFixedTerm = [
  ...
  { inputs: [], name: "Auctioneer_MarketNotActive", type: "error" },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "uint32", name: "defaultTuneInterval", type: "uint32" },
      { indexed: false, internalType: "uint32", name: "defaultTuneAdjustment", type: "uint32" },
      { indexed: false, internalType: "uint32", name: "minDebtDecayInterval", type: "uint32" },
      { indexed: false, internalType: "uint32", name: "minDepositInterval", type: "uint32" },
      { indexed: false, internalType: "uint32", name: "minMarketDuration", type: "uint32" },
      { indexed: false, internalType: "uint32", name: "minDebtBuffer", type: "uint32" },
    ],
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: "uint256", name: "id", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "oldControlVariable", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "newControlVariable", type: "uint256" },
    ],
    name: "Tuned",
    type: "event",
  },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "maxPayout_", type: "uint256" },
    ],
    stateMutability: "view",
    type: "function",
  },
