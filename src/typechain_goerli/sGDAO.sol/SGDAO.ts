...
export interface SGDAOInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "setxGDAO", values: [PromiseOrValue<string>]): string;
...
export interface SGDAO extends BaseContract {
  ...
  callStatic: {
    ...
    setxGDAO(_xGDAO: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
