...
export interface DeployStrongFaucetInterface extends utils.Interface {
  functions: {
...
export interface DeployStrongFaucet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployStrongFaucetInterface;
