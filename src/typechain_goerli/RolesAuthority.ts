...
export interface RolesAuthorityInterface extends utils.Interface {
  ...
  decodeFunctionResult(functionFragment: "doesRoleHaveCapability", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "doesUserHaveRole", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "getRolesWithCapability", data: BytesLike): Result;
...
export type PublicCapabilityUpdatedEvent = TypedEvent<[string, string, boolean], PublicCapabilityUpdatedEventObject>;

export type PublicCapabilityUpdatedEventFilter = TypedEventFilter<PublicCapabilityUpdatedEvent>;
...
export type RoleCapabilityUpdatedEventFilter = TypedEventFilter<RoleCapabilityUpdatedEvent>;
...
export type UserRoleUpdatedEvent = TypedEvent<[string, number, boolean], UserRoleUpdatedEventObject>;
...
export interface RolesAuthority extends BaseContract {
  ...
  functions: {
    ...
    getUserRoles(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    getUserRoles(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getUserRoles(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
