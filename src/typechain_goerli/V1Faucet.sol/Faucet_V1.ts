...
export interface Faucet_V1Interface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "mintXGDAO", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "mintXGDAO", data: BytesLike): Result;
...
export interface Faucet_V1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Faucet_V1Interface;
  ...
  functions: {
    ...
    mintXGDAO(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    mintXGDAO(overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    mintXGDAO(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    mintXGDAO(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<PopulatedTransaction>;
