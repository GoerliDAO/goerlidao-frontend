...
export interface EmergencyInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "restartMinting", values?: undefined): string;
  encodeFunctionData(functionFragment: "restartWithdrawals", values?: undefined): string;
  encodeFunctionData(functionFragment: "shutdown", values?: undefined): string;
  encodeFunctionData(functionFragment: "shutdownMinting", values?: undefined): string;
  encodeFunctionData(functionFragment: "shutdownWithdrawals", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "restartMinting", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "restartWithdrawals", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "shutdown", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "shutdownMinting", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "shutdownWithdrawals", data: BytesLike): Result;
...
export interface Emergency extends BaseContract {
  ...
  functions: {
    ...
    restart(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>;

    restartMinting(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>;

    restartWithdrawals(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>;

    shutdown(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>;

    shutdownMinting(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>;

    shutdownWithdrawals(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>;
  };
  ...
  estimateGas: {
    ...
    restart(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>;

    restartMinting(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>;

    restartWithdrawals(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>;

    shutdown(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>;

    shutdownMinting(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>;

    shutdownWithdrawals(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>;
  };
  ...
  populateTransaction: {
    ...
    restart(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<PopulatedTransaction>;

    restartMinting(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<PopulatedTransaction>;

    restartWithdrawals(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<PopulatedTransaction>;

    shutdown(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<PopulatedTransaction>;

    shutdownMinting(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<PopulatedTransaction>;

    shutdownWithdrawals(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<PopulatedTransaction>;
  };
}
