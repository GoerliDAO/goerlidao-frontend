...
export interface MINTRTestInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "testRevert_CannotMintOrBurnZero", values?: undefined): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: "test_KEYCODE", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "testCorrectness_ApprovedAddressBurnsGdao", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "testRevert_ApprovedAddressCannotMintToZeroAddress", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "testRevert_CannotMintOrBurnZero", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "testRevert_UnapprovedAddressCannotBurnGdao", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "testRevert_UnapprovedAddressCannotMintGdao", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "test_ApprovedAddressMintsGdao", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "test_KEYCODE", data: BytesLike): Result;
...
export interface MINTRTest extends BaseContract {
  ...
  functions: {
    ...
    test_KEYCODE(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>;
  ...
  estimateGas: {
    ...
    testRevert_CannotMintOrBurnZero(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>;
    ...
    test_KEYCODE(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    test_KEYCODE(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<PopulatedTransaction>;
