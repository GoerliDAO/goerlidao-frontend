...
export interface TestGDAOInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "faucetMint", values: [PromiseOrValue<string>]): string;
  encodeFunctionData(
...
export interface TestGDAO extends BaseContract {
  ...
  callStatic: {
    ...
    faucetMint(recipient_: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
