...
export interface UserFactoryInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "create", values: [PromiseOrValue<BigNumberish>]): string;
...
export interface UserFactory extends BaseContract {
  ...
  functions: {
    ...
    next(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>;
  };
  ...
  callStatic: {
    create(userNum: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string[]>;
  ...
  estimateGas: {
    ...
    next(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>;
  };
  ...
  populateTransaction: {
    ...
    next(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<PopulatedTransaction>;
  };
}
