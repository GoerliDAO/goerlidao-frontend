...
export interface TreasuryCustodianTestInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "test_ChangeDebt", values: [PromiseOrValue<BigNumberish>]): string;
  encodeFunctionData(functionFragment: "test_GrantDebtorApproval", values: [PromiseOrValue<BigNumberish>]): string;
  encodeFunctionData(functionFragment: "test_GrantWithdrawerApproval", values: [PromiseOrValue<BigNumberish>]): string;
  encodeFunctionData(functionFragment: "test_RevokeOldPolicyApproval", values?: undefined): string;
  encodeFunctionData(functionFragment: "test_UnauthorizedChangeDebt", values: [PromiseOrValue<BigNumberish>]): string;
  ...
  decodeFunctionResult(functionFragment: "test_ChangeDebt", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "test_GrantDebtorApproval", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "test_GrantWithdrawerApproval", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "test_RevokeOldPolicyApproval", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "test_UnauthorizedChangeDebt", data: BytesLike): Result;
...
export interface TreasuryCustodianTest extends BaseContract {
  ...
  test_RevokeOldPolicyApproval(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    test_ChangeDebt(amount_: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;

    test_GrantDebtorApproval(amount_: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;

    test_GrantWithdrawerApproval(amount_: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;

    test_RevokeOldPolicyApproval(overrides?: CallOverrides): Promise<void>;

    test_UnauthorizedChangeDebt(amount_: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    test_RevokeOldPolicyApproval(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>;
