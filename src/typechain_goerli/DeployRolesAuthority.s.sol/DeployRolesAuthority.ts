...
export interface DeployRolesAuthorityInterface extends utils.Interface {
  functions: {
...
export interface DeployRolesAuthority extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployRolesAuthorityInterface;
