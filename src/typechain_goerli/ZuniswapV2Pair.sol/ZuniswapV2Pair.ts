...
export type SwapEvent = TypedEvent<[string, BigNumber, BigNumber, string], SwapEventObject>;
...
export interface ZuniswapV2Pair extends BaseContract {
  ...
  filters: {
    ...
    Burn(sender?: PromiseOrValue<string> | null, amount0?: null, amount1?: null, to?: null): BurnEventFilter;
