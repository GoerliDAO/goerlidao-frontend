...
export interface DeployFixedBondSDAInterface extends utils.Interface {
  functions: {
...
export interface DeployFixedBondSDA extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployFixedBondSDAInterface;
