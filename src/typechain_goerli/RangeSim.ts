...
export interface RangeSimInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "priceConfig", values?: undefined): string;
  encodeFunctionData(functionFragment: "range", values?: undefined): string;
  encodeFunctionData(functionFragment: "rangeSetup", values: [PromiseOrValue<BigNumberish>]): string;
  encodeFunctionData(functionFragment: "roles", values?: undefined): string;
  encodeFunctionData(functionFragment: "rolesAdmin", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "priceConfig", data: BytesLike): Result;
...
export interface RangeSim extends BaseContract {
  ...
  callStatic: {
    ...
    rangeSetup(key: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
