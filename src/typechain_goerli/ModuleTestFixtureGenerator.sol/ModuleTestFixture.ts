...
export interface ModuleTestFixture extends BaseContract {
  ...
  functions: {
    ...
    configureDependencies(overrides?: CallOverrides): Promise<[string[]] & { dependencies: string[] }>;
  ...
  populateTransaction: {
    ...
    configureDependencies(overrides?: CallOverrides): Promise<PopulatedTransaction>;
