...
export interface VgdaoVaultInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "VESTING_PERIOD", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "VESTING_PERIOD", data: BytesLike): Result;
...
export interface VgdaoVault extends BaseContract {
  ...
  callStatic: {
    ...
    deposit(assets_: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;

    isActive(overrides?: CallOverrides): Promise<boolean>;

    kernel(overrides?: CallOverrides): Promise<string>;

    mint(shares_: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;

    redeem(shares_: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;

    requestPermissions(overrides?: CallOverrides): Promise<PermissionsStructOutput[]>;

    withdraw(assets_: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
