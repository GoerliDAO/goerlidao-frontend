...
export type SlotFoundEvent = TypedEvent<[string, string, string, BigNumber], SlotFoundEventObject>;
...
export type WARNING_UninitedSlotEvent = TypedEvent<[string, BigNumber], WARNING_UninitedSlotEventObject>;
