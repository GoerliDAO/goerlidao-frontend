...
export interface StdErrorInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "arithmeticError", values?: undefined): string;
  encodeFunctionData(functionFragment: "assertionError", values?: undefined): string;
  encodeFunctionData(functionFragment: "divisionError", values?: undefined): string;
  encodeFunctionData(functionFragment: "encodeStorageError", values?: undefined): string;
  encodeFunctionData(functionFragment: "enumConversionError", values?: undefined): string;
  encodeFunctionData(functionFragment: "indexOOBError", values?: undefined): string;
  encodeFunctionData(functionFragment: "lowLevelError", values?: undefined): string;
  encodeFunctionData(functionFragment: "memOverflowError", values?: undefined): string;
  encodeFunctionData(functionFragment: "popError", values?: undefined): string;
  encodeFunctionData(functionFragment: "zeroVarError", values?: undefined): string;

  decodeFunctionResult(functionFragment: "arithmeticError", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "assertionError", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "divisionError", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "encodeStorageError", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "enumConversionError", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "indexOOBError", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "lowLevelError", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "memOverflowError", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "popError", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "zeroVarError", data: BytesLike): Result;
...
export interface StdError extends BaseContract {
  ...
  populateTransaction: {
    ...
    enumConversionError(overrides?: CallOverrides): Promise<PopulatedTransaction>;
