...
import type { IOlympusAuthority, IOlympusAuthorityInterface } from "../../OlympusERC20.sol/IOlympusAuthority";
...
export class IOlympusAuthority__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): IOlympusAuthority {
